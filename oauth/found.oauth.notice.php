 ...
 */
 ...
 /* server path for scripts within the framework to reference each other */
  ...
  define('OAUTH_NOTICE_FOUND', $_SERVER["DOCUMENT_ROOT"].'/../logs/');  /* use define('LOG_CODE_DIR', $_SERVER["DOCUMENT_ROOT"] . '../logs/'); ensure log file is R/W */

  /* log_found('condition1', 'condition2', 'fail_log_working_test', __LINE__ ); */

  function oauth_found($cond1, $cond2, $function, $line) {
   ...
   $fp = fopen(OAUTH_NOTICE_FOUND . 'found.oauth.notice.log','a');
