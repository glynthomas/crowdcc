...
function getdata(url, callback, header, getfrom) {
  ...
  var requesttimer = setTimeout(function() {
     xhReq.abort();
      /* handle timeout situation, e.g. retry or inform user. 2000 === 2 seconds */
   }, 2000);
...
function isradio() {
    ...
    return isradio;
    i = null; radios = null; isradio = null;
}
