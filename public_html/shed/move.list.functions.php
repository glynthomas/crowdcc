 ...
 **********************************************************/
 ...
 /* note : if functions.php NOT in the /slib directory : use */

 // include_once("config.inc.php");
 include_once($_SERVER["DOCUMENT_ROOT"].'/../slib/config.inc.php');
 // include_once("constants.inc.php");
 include_once($_SERVER["DOCUMENT_ROOT"].'/../slib/constants.php');
