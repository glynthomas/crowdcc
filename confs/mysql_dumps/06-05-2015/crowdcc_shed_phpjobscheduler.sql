...
INSERT INTO `phpjobscheduler` VALUES (7,'http://crowdcc.apc/shed/scripts/smin.php','session admin',86400,1431013739,0,0,0),(8,'http://crowdcc.apc/shed/scripts/tmin.php','token admin',86400,1431013782,0,0,0);
