...
INSERT INTO `phpjobscheduler` VALUES (7,'http://crowdcc.apc/shed/scripts/smin.php','session admin',86400,1432568939,1432482539,0,0),(8,'http://crowdcc.apc/shed/scripts/tmin.php','token admin',86400,1432568982,1432482582,0,0);
