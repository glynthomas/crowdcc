...
INSERT INTO `phpjobscheduler` VALUES (4,'http://localhost/~macbook/crowdcc/shed/scripts/smin.php','session admin',3600,1404320185,1404316585,0,0),(5,'http://localhost/~macbook/crowdcc/shed/scripts/tmin.php','token admin',3600,1404320240,1404316640,0,0);
