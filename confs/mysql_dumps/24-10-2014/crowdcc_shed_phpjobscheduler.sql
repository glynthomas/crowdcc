...
INSERT INTO `phpjobscheduler` VALUES (4,'http://localhost/~macbook/crowdcc/shed/scripts/smin.php','session admin',3600,1404050185,1404046585,0,0),(5,'http://localhost/~macbook/crowdcc/shed/scripts/tmin.php','token admin',3600,1404050240,1404046640,0,0);
