...
INSERT INTO `phpjobscheduler` VALUES (7,'http://crowdcc.apc/shed/scripts/smin.php','session admin',86400,1434556139,1434469739,0,0),(8,'http://crowdcc.apc/shed/scripts/tmin.php','token admin',86400,1434556182,1434469782,0,0);
