...
--
-- Host: 127.0.0.1    Database: crowdcc_shed
-- ------------------------------------------------------
...
LOCK TABLES `phpjobscheduler` WRITE;
/*!40000 ALTER TABLE `phpjobscheduler` DISABLE KEYS */;
INSERT INTO `phpjobscheduler` VALUES (4,'http://localhost/~macbook/crowdcc/shed/scripts/smin.php','session admin',3600,1412196985,1412193385,0,0),(5,'http://localhost/~macbook/crowdcc/shed/scripts/tmin.php','token admin',3600,1412197040,1412193440,0,0);
/*!40000 ALTER TABLE `phpjobscheduler` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 21:19:25
