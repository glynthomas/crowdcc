...
INSERT INTO `phpjobscheduler` VALUES (7,'http://crowdcc.apc/shed/scripts/smin.php','session admin',86400,1432914539,1432828139,0,0),(8,'http://crowdcc.apc/shed/scripts/tmin.php','token admin',86400,1432914582,1432828182,0,0);
